...
public class ProcessorViewPanel implements Observer {
	...
	/* Simply add a field to the class, 
	 * add a couple of lines to createProcessorDisplay, 
	 * add an extra line to update 
	 * and change the frame.setSize to (700, 60)
	 */
	...
	public static void main(String[] args) {
		...
		frame.setSize(700, 100); //changed to make the words and boxes visible
